    ...
    public class SeedData
    {
        public static class SessionTypeSeed
        {
            public static List<SessionType> GetSeedData()
            {
                ...
                var sessiontype9 = new SessionType("Holdtræning/genoptræning", new Price(150), 6, new TimeOnly(1, 0), new List<int> { 44444, 66666});
        ...
        public class SessionSeed
        {
            public static List<Session> GetSeedData(List<Client> clients, List<Staff> staff, List<SessionType> sessionTypes, List<Clinic> clinics, List<Promotion> promotions)
            {
                ...
                var session1 = Session.Create(clients[0], staff[0].Id, sessionTypes[0], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextTuesday.AddHours(11).AddMinutes(0), nextTuesday.AddHours(12).AddMinutes(0)), promotions[1], new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session2 = Session.Create(clients[1], staff[1].Id, sessionTypes[4], clinics[0].ClinicRooms[1].Id, new TimeSlot(nextMonday.AddHours(11).AddMinutes(15), nextMonday.AddHours(12).AddMinutes(0)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session3 = Session.Create(clients[2], staff[2].Id, sessionTypes[5], clinics[1].ClinicRooms[0].Id, new TimeSlot(nextWednesday.AddHours(12).AddMinutes(0), nextWednesday.AddHours(13).AddMinutes(0)), promotions[0], new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[1].ClinicOpeningHours);
                var session4 = Session.Create(clients[2], staff[0].Id, sessionTypes[0], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextMonday.AddHours(13).AddMinutes(0), nextMonday.AddHours(14).AddMinutes(0)), promotions[0], new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session5 = Session.Create(clients[1], staff[1].Id, sessionTypes[3], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextMonday.AddHours(13).AddMinutes(15), nextMonday.AddHours(14).AddMinutes(0)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session6 = Session.Create(clients[0], staff[2].Id, sessionTypes[4], clinics[1].ClinicRooms[1].Id, new TimeSlot(nextTuesday.AddHours(14).AddMinutes(0), nextTuesday.AddHours(15).AddMinutes(0)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[1].ClinicOpeningHours);
                var session7 = Session.Create(clients[1], staff[0].Id, sessionTypes[1], clinics[0].ClinicRooms[1].Id, new TimeSlot(nextTuesday.AddHours(13), nextTuesday.AddHours(14)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session8 = Session.Create(clients[2], staff[1].Id, sessionTypes[2], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextWednesday.AddHours(8).AddMinutes(0), nextWednesday.AddHours(9).AddMinutes(0)), promotions[0], new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session9 = Session.Create(clients[1], staff[1].Id, sessionTypes[0], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextWednesday.AddHours(9).AddMinutes(0), nextWednesday.AddHours(9).AddMinutes(45)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session10 = Session.Create(clients[2], staff[0].Id, sessionTypes[5], clinics[0].ClinicRooms[1].Id, new TimeSlot(nextWednesday.AddHours(11).AddMinutes(0), nextWednesday.AddHours(12).AddMinutes(0)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session11 = Session.Create(clients[0], staff[0].Id, sessionTypes[1], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextWednesday.AddHours(11).AddMinutes(30), nextWednesday.AddHours(12).AddMinutes(30)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session12 = Session.Create(clients[1], staff[2].Id, sessionTypes[3], clinics[1].ClinicRooms[0].Id, new TimeSlot(nextThursday.AddHours(13).AddMinutes(0), nextThursday.AddHours(14).AddMinutes(0)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[1].ClinicOpeningHours);
                var session13 = Session.Create(clients[2], staff[0].Id, sessionTypes[4], clinics[0].ClinicRooms[1].Id, new TimeSlot(nextThursday.AddHours(14).AddMinutes(0), nextThursday.AddHours(14).AddMinutes(30)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session14 = Session.Create(clients[2], staff[1].Id, sessionTypes[2], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextThursday.AddHours(14), nextThursday.AddHours(15)), promotions[0], new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session15 = Session.Create(clients[0], staff[2].Id, sessionTypes[0], clinics[1].ClinicRooms[1].Id, new TimeSlot(nextFriday.AddHours(8).AddMinutes(30), nextFriday.AddHours(9).AddMinutes(30)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[1].ClinicOpeningHours);
                var session16 = Session.Create(clients[0], staff[0].Id, sessionTypes[1], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextFriday.AddHours(11).AddMinutes(0), nextFriday.AddHours(12).AddMinutes(0)), promotions[1], new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session17 = Session.Create(clients[1], staff[1].Id, sessionTypes[5], clinics[0].ClinicRooms[1].Id, new TimeSlot(nextFriday.AddHours(11).AddMinutes(15), nextFriday.AddHours(12).AddMinutes(15)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session18 = Session.Create(clients[2], staff[2].Id, sessionTypes[2], clinics[1].ClinicRooms[0].Id, new TimeSlot(nextFriday.AddHours(11).AddMinutes(30), nextFriday.AddHours(12).AddMinutes(30)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[1].ClinicOpeningHours);
                var session19 = Session.Create(clients[2], staff[0].Id, sessionTypes[3], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextFriday.AddHours(12).AddMinutes(30), nextFriday.AddHours(13).AddMinutes(30)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session20 = Session.Create(clients[1], staff[1].Id, sessionTypes[4], clinics[0].ClinicRooms[1].Id, new TimeSlot(nextFriday.AddHours(13).AddMinutes(0), nextFriday.AddHours(14).AddMinutes(0)), promotions[1], new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session21 = Session.Create(clients[0], staff[0].Id, sessionTypes[0], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextMonday.AddHours(8).AddMinutes(0), nextMonday.AddHours(8).AddMinutes(30)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session22 = Session.Create(clients[1], staff[1].Id, sessionTypes[1], clinics[0].ClinicRooms[1].Id, new TimeSlot(nextMonday.AddHours(9).AddMinutes(0), nextMonday.AddHours(10).AddMinutes(0)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
                var session23 = Session.Create(clients[2], staff[2].Id, sessionTypes[2], clinics[1].ClinicRooms[0].Id, new TimeSlot(nextMonday.AddHours(8), nextMonday.AddHours(8).AddMinutes(45)), null, new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[1].ClinicOpeningHours);
                var session24 = Session.Create(clients[2], staff[1].Id, sessionTypes[2], clinics[0].ClinicRooms[0].Id, new TimeSlot(nextWednesday.AddHours(9).AddMinutes(0), nextWednesday.AddHours(10).AddMinutes(0)), promotions[0], new List<Session>(), new List<Session>(), new List<Session>(), dummyPricingFactory, clinics[0].ClinicOpeningHours);
